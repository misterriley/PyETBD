...
class JSONData(object):
	...
	def get_mag_1(self, experiment_index, schedule_index):
		return self.get_from_schedule(_MAG_1, experiment_index, schedule_index, _DEFAULT_MAG)

	def get_mag_2(self, experiment_index, schedule_index):
		return self.get_from_schedule(_MAG_2, experiment_index, schedule_index, _DEFAULT_MAG)
